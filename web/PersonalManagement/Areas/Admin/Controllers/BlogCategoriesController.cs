...
namespace PersonalManagement.Areas.Admin
{
    ...
    public class BlogCategoriesController : Controller
    {
        ...
        public BlogCategoriesController(ApplicationDbContext context, IMapper mapper, IMediator mediator)
        {
            _context = context;
            _mapper = mapper;
            _mediator = mediator;
        ...
        public async Task<IActionResult> Create(IndexViewModel model)
        {
            ...
            {
                var createBlogCategoryCommand = new CreateBlogCategoryCommand()
                {
                    Name = model.CreateBlogCategoryInfor.Name,
                    Description = model.CreateBlogCategoryInfor.Description,
                    Status = model.CreateBlogCategoryInfor.Status
                };
